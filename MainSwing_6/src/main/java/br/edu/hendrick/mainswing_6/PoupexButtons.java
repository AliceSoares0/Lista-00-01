...
public class PoupexButtons implements ActionListener{
    
    private JTextField jurosField, anosField, depositoField;
    private JLabel LFinal;
    private Calcular calcular;

    public PoupexButtons(JTextField jurosField, JTextField anosField, JTextField depositoField, JLabel LFinal) {
