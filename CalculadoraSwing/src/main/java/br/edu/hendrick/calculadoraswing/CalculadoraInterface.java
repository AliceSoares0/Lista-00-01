...
public class CalculadoraInterface extends JFrame {
    ...
    private CalButtons cB;

   
    public CalculadoraInterface() {
        super("Calculadora");
        configureResult();
        setcH(new CalButtons (getResult()));
        configureB0();
        configureB1();
        configureB2();
        configureB3();
    ...
    private void configureBDot() {
        ...
        getbDot().setText(".");
        getbDot().addActionListener(getcB());
    ...
    private void configureBEquals() {
        ...
        getbEquals().setText("=");
        getbEquals().addActionListener(getcB());
    ...
    private void configureBDiv() {
        ...
        getbDiv().setText("/");
        getbDiv().addActionListener(getcB());
    ...
    private void configureBMult() {
        ...
        getbMult().setText("*");
        getbMult().addActionListener(getcB());
    ...
    private void configureBMinus() {
        ...
        getbMinus().setText("-");
        getbMinus().addActionListener(getcB());
    ...
    private void configureBPlus() {
        ...
        getbPlus().setText("+");
        getbPlus().addActionListener(getcB());
 ...
 public CalButtons getcB() {
        return cB;
    }

    public void setcH(CalButtons cB) {
        this.cB = cB;
    }
}